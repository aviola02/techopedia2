            ...
            <div class="col-xs-12">
                ...
                <form id="editForm" method="post" target="dammy_edit" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="edit_field14" name="edit_field14" placeholder="Home Phone..." class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
                    ...
                    <form id="editStaffForm" method="post" target="dammy2" class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                ...
                                <select disabled onchange='selectBoxToTextBox("editType","edit_stafffield11")' class="chosen-select form-control" id="editType" data-placeholder="Choose a Day...">
                                    <option value="02">Secretary</option>
                                    <option value="03">Teacher</option>
                                </select>
            ...
            <div class="col-xs-12">
                ...
                <form id="addClassForm" method="post" target="dammy" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input pattern="[0-2]{1}[0-9]{1}:[0-5]{1}[0-9]{1}" type="text" name="field6" placeholder="In this form 15:55" class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="field7" placeholder="In this form 15:55" class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
...
<script type="text/javascript">
    ...
    var addStudentModal = document.getElementById('myModal');
    var editStudentModal = document.getElementById('myEditModal');
    var viewStudentModal = document.getElementById('myViewModal');
    var addStaffModal = document.getElementById('addStaffModal');
    var editStaffModal = document.getElementById('editStaffModal');
    var viewStaffModal = document.getElementById('myStaffViewModal');
