...
<div class="main-container" id="main-container">
    ...
    <div id="sidebar" class="sidebar                  responsive">
        ...
        <ul class="nav nav-list">
            ...
            <li class="">
                <a id = "showStudents" onclick=showClass("Class")>
                    <i class="menu-icon glyphicon glyphicon-user"></i>
                ...
                <form id="editForm" method="post" target="dammy_edit" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <input required type="text" id="edit_field0" name="edit_field0" placeholder="Put Candidate ID..." class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
    ...
    <div class="modal-content">
        ...
        <div   class="row">
            <div class="col-xs-12">
                <!-- PAGE CONTENT BEGINS -->
                <hr>
                <iframe name="dammy" onchange="addClassSubmitButton()" ></iframe>
                ...
                <form id="editClassForm" method="post" target="classdammy" class="form-horizontal" role="form">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            ...
                            <input required type="text" name="edit_field0" id="edit_Classfield0" placeholder="Name of the Course..." class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input required type="text"  name="edit_field1" id = "edit_Classfield1" placeholder="Class Number..." class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input required type="text" name="edit_field2" id = "edit_Classfield2" placeholder="Year of the seazon..." class="col-xs-10 col-sm-5" />
                        </div>
                    </div>
