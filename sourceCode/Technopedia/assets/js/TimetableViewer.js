...
\
                ...
                <div  class="col-sm-9">\
                    ...
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Start Time: </label>\
                <div class="col-sm-9">\
                    <input pattern="[0-2]{1}[0-9]{1}:[0-5]{1}[0-9]{1}:[0-5]{1}[0-9]{1}" required type="text" name="field5" placeholder="e.g 11:00:00" class="col-xs-10 col-sm-5" />\
                    </div>\
                    </div>\
                    <div class="form-group">\
...
\
                <div style="display: none" class="form-group">\
                    ...
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"> Start Time: </label>\
                        \
                <div class="col-sm-9">\
                    <input pattern="[0-2]{1}[0-9]{1}:[0-5]{1}[0-9]{1}:[0-5]{1}[0-9]{1}" required type="text" id="editEventExam_field3" id="edit_field3" name="edit_field3" value="' + startTime + '" class="col-xs-10 col-sm-5" />\
                    </div>\
                    </div>\
                        \
                    <div class="form-group">\
...
\
                <div class="col-sm-9">\
                    <input pattern="[0-2]{1}[0-9]{1}:[0-5]{1}[0-9]{1}:[0-5]{1}[0-9]{1}" required type="text" id="editEventExam_field4" name="edit_field4" value="' + endTime + '" class="col-xs-10 col-sm-5" />\
                    </div>\
                    </div>\
\
\
...
\
                <div class="col-sm-9">\
                    <input pattern="[0-2]{1}[0-9]{1}:[0-5]{1}[0-9]{1}:[0-5]{1}[0-9]{1}" required type="text" id="editEventExam_field5" name="edit_field5" value="' + startTime + '" class="col-xs-10 col-sm-5" />\
                    </div>\
                    </div>\
                    \
                    \
...
function addEventSubmitButton(){
    ...
    var patt = new RegExp("[0-2]{1}[0-9]{1}:[0-5]{1}[0-9]{1}:[0-5]{1}[0-9]{1}");
    for (var i = 0, element; element = elements[i++];) {
        if (element.type === "text" && element.required==true && element.value == "")
            return;
        else if(element.pattern=="[0-2]{1}[0-9]{1}:[0-5]{1}[0-9]{1}:[0-5]{1}[0-9]{1}" && element.value != "" && patt.test(element.value)==false)
            return;
    }
